  ...
  return (
    <div className="w-full h-full p-2.5 flex flex-col place-items-center ">
      ...
      <div className="h-max flex justify-center place-items-center mx-auto pt-6 space-x-2">
        ...
        <div className="text-white text-3xl xl:text-4xl font-bold max-lg:hidden">
          SHEIN
        </div>
      </div>
      <div className="h-16" />
      ...
      <div className="flex flex-col space-y-3 text-white">
        <Link href={"/storage"}>
          <Button
            variant={"ghost"}
            asChild
            className="h-max flex justify-between rounded-2xl"
          >
            <div>
    ...
    <DropdownMenu>
      <DropdownMenuTrigger>
        <Button
          variant={"ghost"}
          asChild
          className="w-full h-max flex justify-between rounded-2xl"
        >
          <div>
            <div className="w-full flex justify-between place-items-center space-x-3 max-lg:hidden">
              <MdFactory size={20} />

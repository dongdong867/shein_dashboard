...
export const StockStatus = () => {
	return (
		<div className="w-full h-1/3 flex flex-col justify-start place-items-start rounded-[32px] bg-base/90 overflow-y-scroll">
			<div className="w-full flex justify-between place-items-center px-7 pt-7">
			<div className="-space-y-1 font-bold mb-4">
				<div className="text-xl">實時倉庫容量概況</div>
			...
			<StockStatusModal percentage={10} name="test" />
			</div>
		</div>
	)
}

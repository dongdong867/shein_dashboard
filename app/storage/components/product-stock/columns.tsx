...
export const columns: ColumnDef<ProductStock>[] = [
  {
    ...
    header: ({ column }) => <div className="pl-4">倉庫編號</div>,
  ...
  },
  {
    ...
    cell: ({ row }) => (
      <div className="lowercase">{row.getValue("storageName")}</div>
    ),
  },
  {
  ...
  },
  {
    ...
    cell: ({ row }) => (
      <div className="w-max m-auto lowercase text-center">
        {row.getValue("periodCount")}
      </div>
    ),
  },
  {
    ...
    cell: ({ row }) => (
      <div className="lowercase text-center">{row.getValue("amount")}</div>
    ),
  },
];
